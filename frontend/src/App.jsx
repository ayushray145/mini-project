          ...
          <div className="topbar-user">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <path
                  d="M10.05 2.5h3.9l.55 2.3c.18.15.38.31.58.48l2.25-.74 2.77 2.77-.74 2.25c.17.2.33.4.48.58l2.3.55v3.9l-2.3.55c-.15.18-.31.38-.48.58l.74 2.25-2.77 2.77-2.25-.74c-.2.17-.4.33-.58.48l-.55 2.3h-3.9l-.55-2.3a7.8 7.8 0 0 1-.58-.48l-2.25.74-2.77-2.77.74-2.25a7.8 7.8 0 0 1-.48-.58l-2.3-.55v-3.9l2.3-.55c.15-.18.31-.38.48-.58l-.74-2.25 2.77-2.77 2.25.74c.2-.17.4-.33.58-.48l.55-2.3Z"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  strokeLinecap="round"
